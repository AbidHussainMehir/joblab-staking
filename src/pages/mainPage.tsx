...
function MainPage() {
  ...
  return (
    <div className="bg-[#f4f7fc] dark:bg-black p-[20px]">
      <Tabs value="presale">
        <TabsHeader
          className="bg-transparent"
          indicatorProps={{
            className: "bg-gray-900/10 shadow-none !text-gray-900 rounded ",
          }}
        >
          {data.map(({ label, value }) => (
            <Tab
              ...
              className="
              py-2 px-5 text-brand-black-50 dark:text-white"
            >
              {label}
            </Tab>
          ))}
          ...
          {data.map(({ value, desc, title, subTitle }) => (
            <TabPanel key={value} value={value}>
              <div className="rounded-lg flex flex-col items-center justify-center hover:shadow-container bg-white dark:bg-transparent dark:border dark:border-brand-dark-100 border border-black  pt-5 px-8 pb-8">
                ...
                {value == "staking" && (
                  <div className="grid lg:grid-cols-4  grid-cols-1 gap-x-2">
                    ...
                    <Input
                      ...
                      // }
                    />
                    <button className="px-4 py-2  bg-brand-blue-150 dark:bg-transparent dark:border dark:border-brand-dark-100 mt-3 text-brand-blue-100 text-base rounded-lg">
                      Stake!
                    </button>
                    <button className="px-4 py-2  bg-brand-blue-150 dark:bg-transparent dark:border dark:border-brand-dark-100 mt-3 text-brand-blue-100 text-base rounded-lg">
                      Unstake!
                ...
                {value == "staking" && (
                  <div className="grid lg:grid-cols-4  grid-cols-1 gap-x-2 mt-5 ">
